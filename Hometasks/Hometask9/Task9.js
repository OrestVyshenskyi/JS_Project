...
//     h5.innerText = `${simpson.info}`;
//     let img = document.createElement('img');
//     img.classList.add(simpson.photo);
//     div.append(h1, h3, h5, img);
//     document.body.append(div);
//
//
// }
...
//     main.append(block1);
//     let block1_1 = document.createElement('h4');
//     block1_1.classList.add('block1_1');
//     block1_1.innerText = Element.monthDuration;
//     block1.append(block1_1)
//     let block1_2 = document.createElement('h4');
//     block1_2.classList.add('block1_1');
//     block1_2.classList.add()
//     block1_2.innerText = Element.hourDuration;
